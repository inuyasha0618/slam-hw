...
////                weighted_x += image.at<uchar>(kp_x + j, kp_y + i) * j;
////                weighted_y += image.at<uchar>(kp_x + j, kp_y + i) * i;
...
////        kp.angle = kp.angle < 0 ? 360 + kp.angle : kp.angle;
//        // END YOUR CODE HERE
//    }
//    return;
//}
...
//            d[i] = image.at<uchar>((int)rot_py, (int)rot_px) > image.at<uchar>((int)rot_qy, (int)rot_qx) ? false : true;  // if kp goes outside, set d.clear()
//	    // END YOUR CODE HERE
//        }
//        desc.push_back(d);
//    }
...
//void bfMatch(const vector<DescType> &desc1, const vector<DescType> &desc2, vector<cv::DMatch> &matches) {
//    int d_max = 80, desc1_size = desc1.size(), desc2_size = desc2.size();

//    // START YOUR CODE HERE (~12 lines)
//    // find matches between desc1 and desc2.
//    for (int d1 = 0; d1 < desc1_size; d1++) {
//        int min_han = 500;
//        cv::DMatch m;
//        if (desc1.at(d1).empty()) continue;
//        for (int d2 = 0; d2 < desc2_size; d2++) {
//            int distance = 0;
//            if (desc2.at(d2).empty()) continue;
//            for (int i = 0; i < 256; i++) {

//                if (desc1.at(d1).at(i) != desc2.at(d2).at(i)) {
//                    distance += 1;
//                }
//            }
